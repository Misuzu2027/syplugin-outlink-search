...
import { getNodeId } from "./siyuan-util";
...
export async function highlightElementTextByCss(
    ...
    let searchResultsHighlight = CSS.highlights.get("fowardlink-search-result-mark");
    ...
    CSS.highlights.set("fowardlink-search-result-mark", searchResultsHighlight);

}

export function clearCssHighlights() {
    CSS.highlights.delete("fowardlink-search-result-mark");
    CSS.highlights.delete("fowardlink-search-result-focus");
}

export async function highlightElementTextByCssReturnMatchRange(
    contentElement: HTMLElement,
    keywords: string[],
    ...
    if (matchFocusRange) {
        CSS.highlights.set(
            "fowardlink-search-result-focus",
